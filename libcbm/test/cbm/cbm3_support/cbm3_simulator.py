...
def run_cbm3(archive_index_db_path, project_path, toolbox_path,
    ...
    # normpath here, because the toolbox does not like non-windows path
    # seperators
    projectsimulator.run(
        aidb_path=os.path.normpath(archive_index_db_path),
        project_path=os.path.normpath(project_path),
        toolbox_installation_dir=os.path.normpath(toolbox_path),
        cbm_exe_path=os.path.normpath(cbm_exe_path),
        results_database_path=os.path.normpath(cbm3_results_db_path))
...
def get_cbm3_results(cbm3_results_db_path):
    ...
    return {
        ...
        "disturbance": cbm3_dist_indicators_result
        }
